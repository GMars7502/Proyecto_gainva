...
-- Volcando datos para la tabla bd_gainva.almacen: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_gainva.model_has_roles: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_gainva.movimiento_almacen: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_gainva.users: ~4 rows (aproximadamente)
